...
Desde la perspectiva de género y diversidad, el análisis no excluye muestras por sexo. En TCGA-SKCM la variable sexo está disponible y se ha evaluado como covariable en los modelos pronósticos. En cambio, las cohortes GEO del bloque predictivo no disponen de información de sexo armonizada en las variables actualmente utilizadas, lo que se documenta como limitación.
...
La aportación metodológica principal del trabajo consiste en la implementación de una arquitectura de descubrimiento--validación--sensibilidad multi-plataforma que evita la mezcla de efectos biológicos entre tejidos, plataformas y tipos de checkpoint. A diferencia de los enfoques de integración directa multi-cohorte, el diseño adoptado mantiene una sola cohorte de descubrimiento con transcriptoma completo (RNA-seq tumoral anti-PD-1), evalúa las cohortes de validación únicamente mediante solapamiento génico y concordancia de dirección sin reutilizar sus datos para reentrenar el modelo, y reserva el análisis de sangre periférica como sensibilidad exploratoria. Esta estrategia, junto con la verificación explícita de las escalas de entrada por cohorte y la integración de dos bloques analíticos independientes sobre un eje biológico convergente (IFN-$\gamma$/MHC-I), constituye una aportación metodológica respecto a la integración directa de cohortes heterogéneas habitual en la literatura.

\section{Planificación del trabajo}

La planificación se ha adaptado a la evolución metodológica del proyecto. El bloque GEO se ha priorizado por su mayor complejidad técnica y biológica, mientras que el bloque TCGA se mantiene como análisis pronóstico paralelo. La memoria integra ambos bloques de forma diferenciada: pronóstico en TCGA-SKCM y predicción de respuesta en GEO. La Tabla~\ref{tab:planificacion} muestra las fases del proyecto con sus tareas principales y el período de ejecución.

\begin{table}[H]
\centering
\caption{Planificación del trabajo por fases.}
\label{tab:planificacion}
\begin{tabularx}{\textwidth}{l X l}
\toprule
\textbf{Fase} & \textbf{Tareas principales} & \textbf{Período} \\
\midrule
1. Revisión bibliográfica y diseño
  & Estado del arte biológico y computacional. Definición de objetivos y selección de cohortes GEO y TCGA-SKCM.
  & Sep.--Oct.\ 2025 \\
\addlinespace
2. Preprocesamiento y control de calidad
  & Descarga de datos mediante GEOquery y TCGAbiolinks. Construcción de objetos SummarizedExperiment. Control de calidad (boxplot, PCA). Verificación de escalas y filtrado de baja expresión.
  & Oct.--Nov.\ 2025 \\
\addlinespace
3. Bloque predictivo GEO
  & Análisis de expresión diferencial (limma) en GSE78220. Validación en GSE215868 y GSE211645. Validación tumoral RNA-seq en GSE91061. Sensibilidad en sangre periférica (GSE94873). Consistencia multi-cohorte. Modelos LOOCV. Enriquecimiento funcional ORA GO-BP.
  & Nov.\ 2025--Feb.\ 2026 \\
\addlinespace
4. Bloque pronóstico TCGA-SKCM
  & Modelos de Cox univariantes y multivariante sobre variables clínicas. Screening transcriptómico gen a gen. Anotación funcional y ORA GO-BP con clusterProfiler.
  & Ene.--Mar.\ 2026 \\
\addlinespace
5. Redacción e integración
  & Elaboración de la memoria en \LaTeX. Discusión integrativa de ambos bloques. Revisión con tutora e incorporación de feedback. Control de versiones en GitHub.
  & Mar.--May.\ 2026 \\
\bottomrule
\end{tabularx}
\end{table}
...
El capítulo 2 resume el estado del arte biológico y computacional. El capítulo 3 describe los datos y la metodología. El capítulo 4 presenta los resultados de ambos bloques: el bloque predictivo GEO y el bloque pronóstico TCGA-SKCM. El capítulo 5 discute la interpretación biológica y las limitaciones. El capítulo 6 resume conclusiones, planificación y líneas futuras.
