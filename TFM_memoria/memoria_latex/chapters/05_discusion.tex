...
GSE91061 \cite{Riaz2017} es una cohorte tumoral RNA-seq de nivolumab (Riaz et al., 2017), no una cohorte de sangre como se clasificó erróneamente en una versión anterior del análisis. El GEO y la publicación original describen explícitamente biopsias tumorales pre- y on-treatment. Reclasificada correctamente como validación tumoral RNA-seq independiente, el AUC $= 0{,}474$ con 19 genes solapados refleja principalmente la distancia entre cohortes (agente anti-PD-1 diferente, múltiples líneas previas, mezcla de tiempos de biopsia) más que una ausencia de señal biológica real. Este resultado es informativo como control de transferibilidad entre cohortes RNA-seq anti-PD-1.

La falta de transferencia de la firma a sangre periférica (AUC $= 0{,}475$ en GSE94873 con solo 4 genes solapados) es coherente con la distancia biológica (firma tumoral aplicada a sangre total) y técnica (anti-CTLA-4, plataforma NanoString de 162 genes). Este análisis tiene valor exclusivamente como exploración de sensibilidad periférica, y el script \texttt{03\_blood\_sensitivity.Rmd} deberá actualizarse para reflejar la reclasificación de GSE91061 como cohorte tumoral en el análisis definitivo de la PEC4.
