...
\begin{table}[H]
\centering
\caption{Control de calidad y filtrado en GSE78220. Los filtros de varianza cero y baja expresión se aplican conjuntamente (AND lógico); los genes con varianza cero son un subconjunto de los eliminados por baja expresión, por lo que el total efectivamente eliminado es 10.719.}
